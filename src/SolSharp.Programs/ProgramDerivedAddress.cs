...
public static class ProgramDerivedAddress
{
    ...
    /// </summary>
    /// <param name="seeds">The seeds; each may be at most <see cref="MaxSeedLength"/> bytes.</param>
    ...
    /// <exception cref="ArgumentException">A seed exceeds <see cref="MaxSeedLength"/> bytes.</exception>
