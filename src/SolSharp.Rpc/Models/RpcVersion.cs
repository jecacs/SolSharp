...
public sealed record RpcVersion
{
    ...
    {
        get => field ?? throw new InvalidOperationException("The node version has not been initialized.");
        init => field = value ?? throw new JsonException("A version response must carry solana-core.");
    }
