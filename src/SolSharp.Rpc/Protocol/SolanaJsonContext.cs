...
[JsonSerializable(typeof(ProgramIdFilter))]
[JsonSerializable(typeof(RequestAirdropConfig))]
...
[JsonSerializable(typeof(SignatureSubscribeConfig))]
...
[JsonSerializable(typeof(RawMemcmpFilter))]
[JsonSerializable(typeof(DataSizeFilter))]
[JsonSerializable(typeof(LargestAccountsConfig))]
[JsonSerializable(typeof(VoteAccountsConfig))]
[JsonSerializable(typeof(LeaderScheduleConfig))]
...
[JsonSerializable(typeof(RpcAccountData))]
[JsonSerializable(typeof(RpcAccountInfo))]
[JsonSerializable(typeof(RpcProgramAccount))]
...
[JsonSerializable(typeof(RpcContextValue<RpcAccountInfo>))]
[JsonSerializable(typeof(RpcContextValue<RpcAccountInfo?[]>))]
[JsonSerializable(typeof(RpcContextValue<ProgramAccount[]>))]
[JsonSerializable(typeof(RpcContextValue<RpcProgramAccount[]>))]
...
[JsonSerializable(typeof(RpcTransactionVersion))]
...
[JsonSerializable(typeof(IReadOnlyDictionary<string, IReadOnlyList<ulong>>))]
...
[JsonSerializable(typeof(RpcContextValue<ProgramAccount>))]
[JsonSerializable(typeof(RpcContextValue<RpcProgramAccount>))]
[JsonSerializable(typeof(RpcContextValue<ParsedProgramAccount>))]
[JsonSerializable(typeof(RpcContextValue<BlockNotification>))]
[JsonSerializable(typeof(RpcContextValue<ParsedBlockNotification>))]
[JsonSerializable(typeof(RpcContextValue<RawBlockNotification>))]
...
[JsonSerializable(typeof(IReadOnlyList<PublicKey>))]
