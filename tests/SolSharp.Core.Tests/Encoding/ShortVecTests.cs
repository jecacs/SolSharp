...
public static class ShortVecTests
{
    ...
    public sealed class GetByteCount
    {
        ...
        [TestCase(16384, 3)]
        [TestCase(65535, 3)]
        public void AtBoundaries_ReturnsExpected(int value, int expected) => ShortVec.GetByteCount(value).Should().Be(expected);
    }
    ...
    public sealed class Encode
    {
        ...
        public void ReferenceVector_ProducesExpectedBytes(int value, byte[] expected) => ShortVec.Encode(value).Should().Equal(expected);
